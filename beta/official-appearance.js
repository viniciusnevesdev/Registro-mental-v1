/* Registro Mental Oficial 1.2.0-beta.44 — aparência segura, paleta fixa e últimos registros. */
(() => {
  'use strict';

  const RELEASE = '1.2.0-beta.44';
...
(() => {
  try {
    ...
    script.src = `./mood-bar-v2.js?v=1.2.0-beta.51&load=${Date.now()}`;
    script.async = true;
